...
import com.elderly.physical.wellbeing.system.ble.central.BlePeripheralBattery;
import com.elderly.physical.wellbeing.system.ble.central.BlePeripheralDfu;
...
import com.elderly.physical.wellbeing.system.style.RssiUI;
import com.elderly.physical.wellbeing.system.utils.LocalizationManager;
...
//    private final static int MODULE_UART = 1;
    private final static int MODULE_EPWS = 2;
    ...
    public static PeripheralModulesFragment newInstance(@Nullable String singlePeripheralIdentifier) {      // if singlePeripheralIdentifier is null, uses multi-com.elderly.physical.wellbeing.system
    ...
    private void onModuleSelected(int moduleId) {
        ...
        switch (moduleId) {
            case MODULE_EPWS:
                Intent intent = new Intent(getActivity(), GameActivity1Test.class);
...
//                            titleId = R.string.command_tab_title;
//                            break;

                        case MODULE_EPWS:
                            iconDrawableId = R.drawable.tab_calibration_icon;
                            titleId = R.string.game1_tab_title;
                            break;
                    }
...
//                if (hasUart && hasDfu) {
//                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_EPWS};
//                } else if (hasUart) {
//                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_EPWS};
//                } else {
                    return new int[]{MODULE_EPWS};
//                }
            }
        }
