...
import com.elderly.physical.wellbeing.system.ble.peripheral.UartPeripheralModePacketManager;
import com.elderly.physical.wellbeing.system.ble.peripheral.UartPeripheralService;
import com.elderly.physical.wellbeing.system.models.PeripheralModeManager;
...
public class UartServiceFragment extends UartBaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Update ActionBar
        setActionBarTitle(R.string.command_tab_title);
