package com.elderly.physical.wellbeing.system.models;
...
import com.elderly.physical.wellbeing.system.utils.SingleLiveEvent;
...
public class ScannerViewModel extends AndroidViewModel implements BleScanner.BleScannerListener {
    ...
    private List<String> mPeripheralsDiscoveringConnectingOrDiscoveringServices = new ArrayList<>();            // Contains identifiers of peripherals that are connecting (com.elderly.physical.wellbeing.system + discovery)
