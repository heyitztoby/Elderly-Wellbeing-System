package com.elderly.physical.wellbeing.system.mqtt;
...
//                mMqqtClientStatus = MqqtConnectionStatus.DISCONNECTING;
    ...
    public void connect(@NonNull String host, int port, @Nullable String username, @Nullable String password, boolean cleanSession, boolean sslConnection) {
        ...
        if (doConnect) {
            ...
            try {
                Log.d(TAG, "Mqtt: com.elderly.physical.wellbeing.system to " + uri);
    ...
    public void onSuccess(IMqttToken iMqttToken) {
        ...
        if (mMqqtClientStatus == MqqtConnectionStatus.CONNECTING) {
            Log.d(TAG, "Mqtt com.elderly.physical.wellbeing.system onSuccess");
    ...
    public void onFailure(IMqttToken iMqttToken, Throwable throwable) {
        ...
        // Remove the auto-com.elderly.physical.wellbeing.system till the failure is solved
        if (mMqqtClientStatus == MqqtConnectionStatus.CONNECTING) {
